...
* Γενικά η εκπαίδευση είναι κοινωνικό φαινόμενο και για αυτό όλες οι συναντήσεις γίνονται σε μικρές ομάδες. Φυσικά μπορείτε να κανονίσετε μια ατομική συνάντηση κατ'εξαίρεση (π.χ., πτυχιακή) με την ίδια φόρμα ραντεβού που έχουμε για τα μαθήματα και επιλέγοντας στο μενού "πτυχιακή"
